...
import { appRoleEnum, timestamps } from "./enums";

/**
 * Better Auth core tables.
 * IDs are UUID strings (text) for adapter compatibility.
...
/** Normalized roles (complements user.roleFlags jsonb for queries). */
