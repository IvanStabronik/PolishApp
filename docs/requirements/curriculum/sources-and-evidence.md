...
Связанные артефакты: `methodology.md`, `review-checklist.md`, inventories Phase 2, пакет `docs/requirements/` (00–15), A1 review packet [`../../reviews/a1-source-verification.md`](../../reviews/a1-source-verification.md) / [`../../reviews/a1-jpjo-review-packet.md`](../../reviews/a1-jpjo-review-packet.md).

**Бренд:** SŁOWARIUM (`slowarium`). Канонические curriculum ID (`FN-*`, `SCN-*`, …) **не** ребрендируются.
